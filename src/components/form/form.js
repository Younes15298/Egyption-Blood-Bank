...
const Form = ({ isLogIn }) => {
  return (
    <>
      <form>{isLogIn ? <LogIn /> : <Rigester />}</form>
    </>
  );
};
        ...
        <div className="d-flex all">
          <div className="d-flex ">
            <Input
              ...
              id="flexCheckDefault"
            />
            <label className="check-label space" for="flexCheckDefault">
              Remember me
            </label>
          </div>
  ...
  return (
    <>
      ...
      <div className="inputs-form">
        ...
        <div className="row">
          <div className="col-lg-6 col-md-12">
            <select id="inputState" className="form-control input-type select">
        ...
        <div className="form-checkk d-flex">
          ...
          <label className="check-label" for="flexCheckDefault">
            ...
            Praesentium iure maiores expedita fuga quia commodi totam tempora,
            adipisci et explicabo.
          </label>
        </div>
